const projects = [
  {
    ...
    wip: true,
    description: 'Viglore is a full-stack market intelligence platform. Search any company, stock, or topic to get live sentiment analysis powered by VADER NLP, real-time news aggregation, Wikipedia context, stock prices via Alpha Vantage, trader sentiment via Stocktwits, and an interactive Tech City Intelligence page ranking 90+ US cities by jobs, salary, cost of living, and startup activity.',
    tags: ['React', 'FastAPI', 'Python', 'Tailwind', 'VADER NLP', 'Alpha Vantage API', 'Stocktwits API', 'NewsAPI'],
