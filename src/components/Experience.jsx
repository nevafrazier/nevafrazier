const jobs = [
  {
    ...
    badge: 'Current',
    bullets: [
      'Developed an AI-powered automation agent that retrieves tracking links, populates shipment statuses, and calculates days-in-transit in Google Sheets — saving an estimated 35 minutes per day.',
      'Analyzed user and product data across Mixpanel and Metabase, surfacing shipping trends that informed escalation of 500+ delayed packages.',
      'Maintained 3+ recurring reports weekly, building SQL dashboards and Google Sheets reports adopted team-wide for daily decision-making.',
      'Built a daily cohort report visualizing shipping status trends, shared with operations and leadership teams.',
      'Organized and categorized 50+ marketing advertisement assets monthly across Airtable and Dropbox — collaborating with the marketing team to standardize workflows.',
      'Consolidated cancelled order data from Airtable and Willow Admin into a daily tracking report, surfacing exceptions for faster resolution.',
    ],
  },
  {
    company: 'Starbucks',
